        ...
        <div className="auth-buttons">
            {isLoggedIn ? (
                ...
                <button className="logout-button" onClick={handleLogoutClick}>
                    <img src="https://www.dropbox.com/scl/fi/u7k7daltajqg3myiaud0j/logout-icon.svg?rlkey=gb11yrggffu7kowqyq9muwyzw&st=4q66hybj&raw=1" alt="Logout button" />
                </button>
                <button className="upload-icon" onClick={handleUploadClick}>
                    <img src="https://www.dropbox.com/scl/fi/o4cednhkybd1ty8xsp5x7/upload-icon.png?rlkey=0ymn2yz9rqdpuyf2hd50hoa7o&st=0t6y1zo8&dl&raw=1" alt="Upload icon"/>
                </button>
                <button className="user-icon" onClick={handleProfileClick}>
                    <img src="https://www.dropbox.com/scl/fi/hfz5wn581d6rot1ccxuyh/user-icon.png?rlkey=hm75yyttqaw7hb8n5tk3ja3xq&st=rknzoa1v&dl&raw=1" alt="User icon"/>
                </button>
                </>
            ) : (
                <>
